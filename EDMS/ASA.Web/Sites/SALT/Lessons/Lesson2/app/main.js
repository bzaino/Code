...
function (app, Router, SALT, SiteMember, WT) {
    ...
    SALT.on('content:todo:completed', function() {
        SiteMember.done(function (siteMember) {
            var todoObject = { MemberID: siteMember.MembershipId, ContentID: '101-4332', RefToDoStatusID: 2, RefToDoTypeID: 1 };
            SALT.services.upsertTodo(function () {}, JSON.stringify(todoObject));
        });
    });
    SALT.on('content:todo:inProgress', function() {
        SiteMember.done(function (siteMember) {
            var todoObject = { MemberID: siteMember.MembershipId, ContentID: '101-4332', RefToDoStatusID: 4, RefToDoTypeID: 1 };
            SALT.services.upsertTodo(function () {}, JSON.stringify(todoObject));
        });
    });
        ...
        if (individualId) {
            ...
            SiteMember.done(function (siteMember) {
                if (siteMember.IsAuthenticated === 'true') {
                    ...
                    var href = location.protocol + '//' + location.host + '/index.html?ReturnUrl=/lesson2/';

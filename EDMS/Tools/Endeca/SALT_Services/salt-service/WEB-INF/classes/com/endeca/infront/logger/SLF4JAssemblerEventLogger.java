...
package com.endeca.infront.logger;
 ...
 */
public class SLF4JAssemblerEventLogger 
    extends AssemblerEventAdapter
{
    ...
    {
        logger.debug("preprocessing " + event.getContentItem().getType() + " using " + event.getCartridgeHandler().getClass());
    }

    @Override 
    public void cartridgePreprocessComplete(AssemblerEvent event)
    {
        logger.debug("preprocessed " + event.getContentItem().getType() + " using " + event.getCartridgeHandler().getClass());
    }
    ...
    {
        logger.debug("processed " + event.getContentItem().getType() + " using " + event.getCartridgeHandler().getClass());
    }

    @Override 
    public void cartridgeError(AssemblerEvent event)
    {
        logger.error("cartridge error:", event.getError());
    }
}

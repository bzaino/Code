///////////////////////////////////////////////////////////////////////////////
//
//  WorkFile Name:	ASALogManager.cs
//
...
{
    public class ASALogManager
    {
		#region Static Member Variables

		/// <summary>
		/// The wrapper map to use to hold the <see cref="ILogExtImpl"/> objects
		/// </summary>
		...
		public static IASALog Exists(string name) 
		{
		...
		/// <param name="name">The fully qualified logger name to look for</param>
		/// <returns>The logger found, or null</returns>
        public static IASALog Exists(string domain, string name) 
		{
		...
		/// <param name="name">The fully qualified logger name to look for</param>
		/// <returns>The logger found, or null</returns>
        public static IASALog Exists(Assembly assembly, string name) 
		{
        ...
        public static IASALog[] GetCurrentLoggers()
		{
		...
		/// </remarks>
		/// <returns>All the defined loggers</returns>
        public static IASALog[] GetCurrentLoggers(string domain)
		{
		...
		/// </remarks>
		/// <returns>All the defined loggers</returns>
        public static IASALog[] GetCurrentLoggers(Assembly assembly)
		{
        ...
        public static IASALog GetLogger(string name)
		{
		...
		/// <param name="name">The name of the logger to retrieve.</param>
		/// <returns>the logger with the name specified</returns>
        public static IASALog GetLogger(string domain, string name)
		{
		...
		/// <param name="name">The name of the logger to retrieve.</param>
		/// <returns>the logger with the name specified</returns>
        public static IASALog GetLogger(Assembly assembly, string name)
		{
		...
		/// <returns>the logger with the name specified</returns>
        public static IASALog GetLogger(Type type) 
		{
		...
		/// be used as the name of the logger to retrieve.</param>
		/// <returns>the logger with the name specified</returns>
        public static IASALog GetLogger(string domain, Type type) 
		{
		...
		/// be used as the name of the logger to retrieve.</param>
		/// <returns>the logger with the name specified</returns>
        public static IASALog GetLogger(Assembly assembly, Type type) 
		{
        ...
        private static IASALog WrapLogger(ILogger logger)
		{
            return (IASALog)s_wrapperMap.GetWrapper(logger);
		}
        ...
        private static IASALog[] WrapLoggers(ILogger[] loggers)
		{
            IASALog[] results = new IASALog[loggers.Length];
